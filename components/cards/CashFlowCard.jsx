...
export default function CashFlow({ income, expense }) {
  ...
  return (
    <div className=" content-fix h-24 flex items-center justify-between  overflow-hidden gap-2 border-2 border-gray-200 shadow-sm rounded-2xl p-4 bg-white">
      {/* Income */}
      <div className="flex flex-1 items-center ml-6 border-r border-gray-300">
